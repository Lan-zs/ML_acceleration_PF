"""
Receptive field visualization for specified points in grain growth images.
...
def analyze_receptive_field_for_specified_points(
    ...
    data_to_save = {
        ...
        'points': points,
        'crop_region': (65, 165, 115, 215)  # y_min, y_max, x_min, x_max
    }
    ...
    # Crop region
    y_min, y_max, x_min, x_max = 65, 165, 115, 215
...
def main():
    ...
    base_save_dir = os.path.join(
        ...
        'experiment_results',
        'augmentation ScaledResNet_C32_NB8_K3_ndt1',
        'specified_points_receptive_field_analysis'
    )


    # Frame configurations with specified points
    frame_configs = {
        14: [(81, 140), (120, 164), (143, 188), (101, 155), (80, 183), (155, 145), (122, 129)],
        201: [(81, 140), (110, 164), (143, 193), (95, 195), (80, 166), (145, 141), (128, 129), (100, 145)],
        401: [(90, 135), (118, 153), (140, 183), (80, 155), (100, 190), (155, 145), (122, 135), (130, 205)],
        601: [(85, 147), (123, 164), (143, 188), (107, 143), (100, 187), (150, 144), (110, 126)]
    }
