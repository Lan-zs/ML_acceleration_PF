...
from evaluation.evaluator import model_testing, long_rollout_testing, rollout_from_multiple_frames
from utils.visualization import plot_train_loss_curve
...
def run_experiment(
    ...
    if run_evaluation:
        ...
        start_frames = [0, 200, 400, 600, 800]
        ...
        for h5_file in os.listdir(evaluation_folder):  # Test on first 2 files
            if h5_file.endswith(".h5"):
                ...
                valid_start_frames, final_errors = rollout_from_multiple_frames(
                    model, phi_data, temp_data, start_frames, file_output_dir, step_interval=900
                )
...
def main():
    ...
    save_path = os.path.join(repo_root, "ideal_grain_growth", "experiment_results")
    train_folder = os.path.join(repo_root, "dataset", "grain_growth", "Training_save100dt")
    test_folder = os.path.join(repo_root, "dataset", "grain_growth", "Test", "256")
