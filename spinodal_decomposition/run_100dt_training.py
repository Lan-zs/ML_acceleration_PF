"""
Main experiment runner for spinodal decomposition 100dt prediction models.
...
def main():
    ...
    save_path = os.path.join(repo_root, "spinodal_decomposition", "100dt_model_results")
    train_folder = os.path.join(repo_root, "dataset", "spinodal_decomposition_100dt", "Training")
    test_folder = os.path.join(repo_root, "dataset", "spinodal_decomposition_100dt", "Test")
