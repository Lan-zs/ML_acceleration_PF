"""
Main experiment runner for spinodal decomposition 100dt prediction models (Non-Sigmoid).
...
def run_experiment(
    ...
    model_name = f"ResResNet_C{base_channels}_NB{num_blocks}_K{kernel_size}_ndt{ndt}"
        ...
        for h5_file in os.listdir(evaluation_folder):
            if h5_file.endswith(".h5"):
                ...
                for evaluation_mode in evaluation_modes:
                    ...
                    indices = [100,200,300,450]  # Time indices for detailed analysis
...
def main():
    ...
    # Paths
    save_path = "100dt_model_results_nonsigmoid"
    train_folder = "/raid0/zhangzc/zshlan/DeepGrainGrowth/Github_code/dataset/spinodal_decomposition_100dt/Training"
    test_folder = "/raid0/zhangzc/zshlan/DeepGrainGrowth/Github_code/dataset/spinodal_decomposition_100dt/Test"
    evaluation_folder = "/raid0/zhangzc/zshlan/DeepGrainGrowth/Github_code/dataset/spinodal_decomposition_100dt/Test"
    ...
    experiments = [
        {"base_channels": 32, "num_blocks": 8, "kernel_size": 3, "ndt": 1},
