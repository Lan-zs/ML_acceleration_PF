"""
Main experiment runner for spinodal decomposition 10dt prediction models.
            ...
            if h5_file.endswith(".h5"):
                ...
                for evaluation_mode in evaluation_modes:
                    ...
                    model_testing(
                        ...
                        evaluation_mode, assess_metrics='MAE', step_interval=20
                    )
...
def main():
    ...
    save_path = os.path.join(repo_root, "spinodal_decomposition", "10dt_model_results")
    train_folder = os.path.join(repo_root, "dataset", "spinodal_decomposition_10dt", "Training")
    test_folder = os.path.join(repo_root, "dataset", "spinodal_decomposition_10dt", "Test")
    evaluation_folder = os.path.join(repo_root, "dataset", "spinodal_decomposition_10dt", "Evaluation")
    ...
    experiments = [
        {"base_channels": 32, "num_blocks": 8, "kernel_size": 3, "ndt": 10},
