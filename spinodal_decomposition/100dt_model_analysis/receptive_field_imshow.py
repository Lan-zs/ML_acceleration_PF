...
def main():
    ...
    base_save_dir = "/raid0/zhangzc/zshlan/DeepGrainGrowth/Github_code/spinodal_decomposition/100dt_model_results_min175/augmentation ScaledResNet_C32_NB8_K3_ndt1/specified_points_receptive_field_analysis"  # Update this path
