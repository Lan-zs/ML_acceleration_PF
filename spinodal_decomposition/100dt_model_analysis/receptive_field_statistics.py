...
def load_model(model_path: str, device: str = 'cpu') -> ResidualConcatNet:
    """
...
def main():
    ...
    save_dir = "/raid0/zhangzc/zshlan/DeepGrainGrowth/Github_code/spinodal_decomposition/100dt_model_results_min175/augmentation ScaledResNet_C32_NB8_K3_ndt1/effective_receptive_field_analysis"  # Update this path
