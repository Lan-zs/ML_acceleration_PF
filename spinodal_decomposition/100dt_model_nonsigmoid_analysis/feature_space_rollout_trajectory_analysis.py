...
def main():
    ...
    save_dir = "/raid0/zhangzc/zshlan/DeepGrainGrowth/Github_code/spinodal_decomposition/100dt_model_results_min175/augmentation ScaledResNet_C32_NB8_K3_ndt1/feature_space_analysis/rollout_fixed_points"  # Update this path
